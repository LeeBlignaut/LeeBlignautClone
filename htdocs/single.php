            ...
            if ($cart =='yes') 
                {
                 $arrCart = $_SESSION['CART'];
                                    ...
                                    $arrNew = array($product->getId()=>$product->getPrice());
                                   
                                    
                                    $arrCart = $arrCart + $arrNew;
		    ...
		    <div class="content-grids">
		    	<div class="details-page">
		    		<div class="back-links">
		    			<ul>
                                            ...
                                            <li><a href="store.php">Store</a><img src="images/arrow.png" alt=""></li>
		    	...
		    	<div class="detalis-image">
		    		<div class="flexslider">
						<ul class="slides">
                                                    <?php 
                                                        echo '<li data-thumb="'.$product->getLocation().'">';
                                                        echo '<div class="thumb-image"> <img src="'.$product->getLocation().'" height="300px" weight="427px" data-imagezoom="true" class="img-responsive" alt="" /> </div>';
                                                        echo '</li>';
		    	...
		    	<div class="detalis-image-details">
		    		...
		    		<div class="brand-value">
                                    <h3><?php echo $product->getBrand()." ". $product->getName()?></h3>
		    			<div class="left-value-details">
			    			<ul>
			    				<li>Price:</li>
                                                        <li><h5><?php echo 'R '.$product->getPrice();?></h5></li>
			    				<br />
			    				
			    			</ul>
		    			</div>
		    			<div class="right-value-details">
			    			<?php echo 'InStock : '.$inventory->getAmount() ?>
		    		...
		    		<div class="brand-history">
		    			...
		    			<?php echo '<p>'.$product->getDescription().' </p>';
                                              echo '<p> </p>';?>
                                        <?php echo '<a href="single.php?id='.$product->getId().'&cart=yes">Addcart</a>';
                                         
                                       if (isset($_COOKIE['Logged_User'])) 
                                    {
                                   
                                    
                                    echo '<a href="Update.php?id='.$product->getId().'"> Update</a>';
                                    echo '<a href="Delete.php?id='.$product->getId().'">Delete</a>';
